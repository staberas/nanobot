...
class ModelPresetConfig(Base):
    ...
    plain_chat_when_tools_unsupported: bool | None = Field(
        default=None,
        validation_alias=AliasChoices("plainChatWhenToolsUnsupported", "plain_chat_when_tools_unsupported"),
        serialization_alias="plainChatWhenToolsUnsupported",
    )
    plain_chat_system_prompt: str | None = Field(
        default=None,
        validation_alias=AliasChoices("plainChatSystemPrompt", "plain_chat_system_prompt"),
        serialization_alias="plainChatSystemPrompt",
    )
...
class AgentDefaults(Base):
    ...
    tool_selection: ToolSelectionConfig | None = None
    plain_chat_when_tools_unsupported: bool = Field(
        default=False,
        validation_alias=AliasChoices("plainChatWhenToolsUnsupported", "plain_chat_when_tools_unsupported"),
        serialization_alias="plainChatWhenToolsUnsupported",
    )
    plain_chat_system_prompt: str = Field(
        default="You are a concise assistant. Reply in plain text only.",
        validation_alias=AliasChoices("plainChatSystemPrompt", "plain_chat_system_prompt"),
        serialization_alias="plainChatSystemPrompt",
    )
